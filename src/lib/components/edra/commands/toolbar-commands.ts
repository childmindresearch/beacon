...
const commands: Record<string, EdraToolBarCommands[]> = {
    ...
    templates: [
...

        {
            ...
            tooltip: 'Child Name',
            onClick: (editor) => {
                editor.commands.setTemplate('Parent', ['Child Name'])
            },
        },
        {
            icon: LayoutTemplateIcon,
            ...
            tooltip: 'He/She/They',
            onClick: (editor) => {
                editor.commands.setTemplate('Pronoun-0', ['he', 'she', 'they'])
            },
        },
        {
            icon: LayoutTemplateIcon,
            ...
            onClick: (editor) => {
                editor.commands.setTemplate('Pronoun-1', [
                    'him',
                    'her',
                    'their',
                ])
        ...
        },
        {
            ...
            onClick: (editor) => {
                editor.commands.setTemplate('Pronoun-2', [
                    'his',
                    'her',
                    'their',
                ])
        ...
        },
        {
            ...
            onClick: (editor) => {
                editor.commands.setTemplate('Pronoun-3', [
                    'his',
                    'hers',
                    'theirs',
                ])
        ...
        },
        {
            ...
            onClick: (editor) => {
                editor.commands.setTemplate('Pronoun-4', [
                    'himself',
                    'herself',
                    'themself',
                ])
